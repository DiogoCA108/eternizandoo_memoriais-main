import fotoCasamento from "@/assets/gallery/foto-casamento-1963.jpg";
import fotoFilhos from "@/assets/gallery/foto-filhos-1975.jpg";
import fotoFormatura from "@/assets/gallery/foto-formatura.jpg";
import fotoNatal1990 from "@/assets/gallery/foto-natal-1990.jpg";
import fotoJardim from "@/assets/gallery/foto-jardim.jpg";
import fotoNetos from "@/assets/gallery/foto-netos-2010.jpg";
import fotoAniversario80 from "@/assets/gallery/foto-aniversario-80.jpg";
import fotoNatal2023 from "@/assets/gallery/foto-natal-2023.jpg";
import fotoProfessora from "@/assets/gallery/foto-professora.jpg";
import fotoCozinhando from "@/assets/gallery/foto-cozinhando.jpg";
import fotoCasalParque from "@/assets/gallery/foto-casal-parque.jpg";
import fotoIgreja from "@/assets/gallery/foto-igreja.jpg";

export const memorialData_Joao = {
...
Nos últimos anos, dedicou-se aos netos, à igreja e ao jardim que cultivava com carinho. Partiu serenamente, cercada pelo amor de sua família, deixando um legado de bondade, fé e esperança.`,
  ...
  galeria: [
    { tipo: "foto" as const, url: fotoCasamento, legenda: "Casamento, 1900" },
    { tipo: "foto" as const, url: fotoFilhos, legenda: "Com os filhos, 1975" },
    { tipo: "foto" as const, url: fotoFormatura, legenda: "Formatura como professora" },
    { tipo: "foto" as const, url: fotoNatal1990, legenda: "Natal em família, 1990" },
    { tipo: "foto" as const, url: fotoJardim, legenda: "No jardim que tanto amava" },
    { tipo: "foto" as const, url: fotoNetos, legenda: "Com os netos, 2010" },
    { tipo: "foto" as const, url: fotoAniversario80, legenda: "Aniversário de 80 anos" },
    { tipo: "foto" as const, url: fotoNatal2023, legenda: "Último Natal juntos, 2023" },
    { tipo: "foto" as const, url: fotoProfessora, legenda: "Dona Helena na sala de aula" },
    { tipo: "foto" as const, url: fotoCozinhando, legenda: "Preparando o bolo de fubá" },
    { tipo: "foto" as const, url: fotoCasalParque, legenda: "Com Antônio Carlos no parque" },
    { tipo: "foto" as const, url: fotoIgreja, legenda: "Família após a missa de domingo" },
  ],
